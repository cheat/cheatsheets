...
# Example:
java -Xms<256m> -Xmx<2g> -Xss<1m> -jar <path/to/file.jar>

# To use the classpath variable:
java -classpath <classpath> -jar <path/to/file.jar>
java -classpath <my/example/path/one:my/example/path/two> -jar <path/to/file.zip>
